    ...
    <div class="mx-auto w-full max-w-screen-xl">
      <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        <div>
            ...
            <i className="fas fa-gem me-3" />Company name</h2>
            <p>
        ...
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li class="mb-4">
                    <a href="#" class="hover:underline">Smart Phone</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="hover:underline">Electronic</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="hover:underline">Clothes</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="hover:underline">TV</a>
                </li>
                <li class="mb-4">
        ...
        <div>
            ...
            <ul class="text-gray-500 dark:text-gray-400 font-medium">
              ...
              info@example.com</a>
                ...
                <li class="mb-4">
                    <a href="#" class="hover:underline"><i className="fas fa-phone me-3" /> + 01 234 567 88</a>
                </li>
                <li class="mb-4">
                    <a href="#" class="hover:underline"><i className="fas fa-print me-3" /> + 01 234 567 89</a>
                </li>
            </ul>
        </div>
    </div>
